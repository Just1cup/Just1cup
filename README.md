<!-- HEADER -->
<img width=100% src="https://capsule-render.vercel.app/api?type=waving&color=0:0f172a,100:5b21b6&height=140&section=header"/>

<h1 align="center">Paulo Henrique</h1>
<p align="center">
Cybersecurity Analyst | Threat Detection | CTI | SOC Engineering
</p>

<p align="center">
Focused on threat detection, intelligence-driven analysis, and building tools that improve SOC workflows.
</p>
...
### 🛡️ Detection & Threat Intelligence
...
### 🔍 SOCINTEL — Threat Intelligence Platform
- IOC enrichment (VirusTotal, AbuseIPDB, OTX, urlscan)
- Centralized investigation workflow
- Risk scoring system
- Built for SOC analysts to reduce investigation time
